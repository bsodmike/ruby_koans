...
class AboutClassMethods < Neo::Koan
  ...
  # NOTE: The above could have been done as `def self.wag` within the scope of `Dog2`;
  # alternatively `class << self` provides access to the eigenclass.
  ...
  class Dog
    ...
    def self.and_another_class_method
      :dogs_other_class_method
    end
  end

  def test_you_can_define_class_methods_inside_the_class
    assert_equal :dogs_class_method, Dog.a_class_method
    assert_equal :dogs_other_class_method, Dog.and_another_class_method
  end
  ...
  #
  # I normally reach for `class << self` although most style guides are against
  # this; therefore, my use for this depends on the project I'm on and if I need
  # to make changes within the eigenclass itself, i.e. such as setting up
  # class-instance variables by hand.
  #
  # Are there times you might prefer one over the other?
  #
  # Yes, when I only have a few class methods the former approach is cleaner.
