...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # In the invent an instance methods `#send` has already been defined. See my
    # previous example of the US nuking Russia, in `about_methods.rb`.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # Well, that's how Rails handles lots of cases (as well as other libraries
    # such as RefineryCMS etc); it allows us to handle any method that hasn't
    # been defined.
    #
    # NOTE:
    #
