...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # Ideally, never; there may be cases to cause failure though. (Not sure).
  end
  ...
  # Why?
  #
  # Here's a good example, `%(this is <a href="asdasd">a link</a>)[/<.*>/]`
  # It will be _greedy_ enough to grab the entire link-tag, rather than just the
  # opening tag.
  ...
  #
  # Character classes are most likely evaluated in a single step by the regex
  # engine; alternation provides a set of potential matches that need to be
  # tried successively.  The former presents the shortest and more readable
  # solution.
