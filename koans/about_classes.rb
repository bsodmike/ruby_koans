...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_cannot_be_accessed_outside_the_class
    ...
    # However, here's a metaprogramming trick!
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    #
    # Had Dog6 been initialised with `initialize` and no proceeding paranthesis,
    # then `Dog6.new` would still be valid, however, any variables defined
    # - without a default value, are expected.
  end
